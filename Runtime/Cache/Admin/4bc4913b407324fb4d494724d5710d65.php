...
<head>
    ...
    <link href="/whs/Public/favicon.ico" type="image/x-icon" rel="shortcut icon">
    <link rel="stylesheet" type="text/css" href="/whs/Public/Admin/css/base.css" media="all">
    <link rel="stylesheet" type="text/css" href="/whs/Public/Admin/css/common.css" media="all">
    <link rel="stylesheet" type="text/css" href="/whs/Public/Admin/css/module.css">
    <link rel="stylesheet" type="text/css" href="/whs/Public/Admin/css/style.css" media="all">
	<link rel="stylesheet" type="text/css" href="/whs/Public/Admin/css/<?php echo (C("COLOR_STYLE")); ?>.css" media="all">
     <!--[if lt IE 9]>
    <script type="text/javascript" src="/whs/Public/static/jquery-1.10.2.min.js"></script>
    <![endif]--><!--[if gte IE 9]><!-->
    <script type="text/javascript" src="/whs/Public/static/jquery-2.0.3.min.js"></script>
    <script type="text/javascript" src="/whs/Public/Admin/js/jquery.mousewheel.js"></script>
    <!--<![endif]-->
...
<body>
    ...
    (function(){
        var ThinkPHP = window.Think = {
            "ROOT"   : "/whs", //当前网站地址
            "APP"    : "/whs/index.php", //当前项目地址
            "PUBLIC" : "/whs/Public", //项目公共目录地址
    ...
    <script type="text/javascript" src="/whs/Public/static/think.js"></script>
    <script type="text/javascript" src="/whs/Public/Admin/js/common.js"></script>
    <script type="text/javascript">
        +function(){
...
<script type="text/javascript" src="/whs/Public/static/jquery.dragsort-0.5.1.min.js"></script>
